...
if uploaded_file is not None:
    ...
    # Convert the image to RGB for correct color display in Streamlit
    image_rgb = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)

    # Display the image with detected faces
    st.image(image_rgb, caption="Image with Detected Faces", use_container_width=True, channels="BGR")
